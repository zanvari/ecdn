...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--fineSize', type=int, default=320, help='then crop to this size')
        # model parameters
        ...
        parser.add_argument('--netG', type=str, default='unet_resnet_6blocks', help='specify generator architecture [resnet_9blocks_enhance_2blocks_skip | resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
        ...
        parser.add_argument('--n_layers_patchD', type=int, default=4, help='only used if which_model_netD==n_layers')
        ...
        parser.add_argument('--patchD_3', type=int, default=5, help='choose the number of crop for patch discriminator')
        ...
        parser.add_argument('--high_times', type=int, default=400, help='choose the number of crop for patch discriminator')
